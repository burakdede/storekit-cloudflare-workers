/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=example/wrangler.jsonc` (hash: e2a77afb021717cd04e806041201e219)
...
interface __BaseEnv_Env {
	...
	STOREKIT_ALLOW_GRACE_PERIOD_ACCESS: "true";
	STOREKIT_RECONCILE_NOTIFICATIONS: "true";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./example/src/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STOREKIT_ALLOWED_ENVIRONMENTS" | "STOREKIT_ALLOWED_PRODUCT_IDS" | "STOREKIT_BUNDLE_ID" | "APP_STORE_APP_APPLE_ID" | "STOREKIT_ALLOW_APPLE_LOOKUP_FALLBACK" | "STOREKIT_ALLOW_GRACE_PERIOD_ACCESS" | "STOREKIT_RECONCILE_NOTIFICATIONS">> {}
}
